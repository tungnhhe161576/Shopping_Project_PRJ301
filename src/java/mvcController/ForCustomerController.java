...
@WebServlet(name = "ForCustomerController", urlPatterns = {"/ForCustomerController"})
public class ForCustomerController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (service.equals("display")) {
                ...
                String href = "ForCustomerController?service=display";
            ...
            if (service.equals("displayCategory")) {
                ...
                int indexP = Integer.parseInt(index);
                String href = "ForCustomerController?service=displayCategory&cname=" + cname;
                request.setAttribute("endP", endP);
                request.setAttribute("indexP", indexP);
                request.setAttribute("href", href);
