...
<html>
    ...
    <body  style="background-color: rgb(249, 242, 242)">
            <div class="intro" style="background-color: rgb(249, 242, 242)">
                <jsp:include page="IntroHome.jsp"></jsp:include>
            </div>
            ...
            <div class="header bg-dark container-fluit">
                <div class="row">
                    <div class="col-md-2 left text-white">
                        <a href="HomeController?service=display">Home</a> 
                        <a href="ShowCart"> Cart <span class="badge badge-danger">${count}</span> </a>
                    </div>
                    ...
                    <div class="col-md-4 right" style="float: right">
                        <a href="HomeController?service=desc">Descending</a> 
                        <a href="HomeController?service=asc">Ascending</a> 
                        <a href="Login?service=loginCustomer">Log In</a> 
                ...
                <div class="row" style="padding-top: 15px">
                    ...
                    <table class="table table-hover table-bordered  bg-white">
                        ...
                        <tbody>
                            <% while(rs.next()) {%>
                            <tr>
                                <td><a  href="HomeController?service=displayCategory&cname=<%=rs.getString(1)%>"><%=rs.getString(1)%></a></td>
                            </tr>
                            <% } %>
                        </tbody>
                    </table>
                        ...
                        <div class="col-md-3">                
                            <div class="product-item border-0 mb-4 bg-white">
                                ...
                                <div class="card-footer d-flex justify-content-between bg-light border">
                                    ...
                                    <a href="Cart?service=addToCart&id=<%=o.getProduct_id()%>" class="btn btn-sm text-dark p-0">Add To Cart</a>
                                </div>
                            </div>                  
                        </div>
                        <%}%>
