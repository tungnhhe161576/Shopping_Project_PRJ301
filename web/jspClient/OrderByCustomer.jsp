...
<html>
    <head>
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Order By Customer Page</title>
    </head>
    <body>
        
        <div class="header container bg-dark">
            <div class="row">
                    <a class="text-white text-center" href="ForCustomerController">Home</a> 
            </div>
        </div>
        
        <div class="container">
            <div style="margin-top: 40px"> <h3>Your Order !</h3></div>
                ...
                <table class="table table-bordered  bg-white">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <%=rsOrder.getInt(6)%> </td>
                            <td> <%=rsOrder.getDouble(7)%> </td>
